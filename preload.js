...
contextBridge.exposeInMainWorld('api', {
  ...
  agent: {
    ...
    mcpListServers: ()              => ipcRenderer.invoke('agent:mcpListServers'),
    mcpAddServer:   (server)        => ipcRenderer.invoke('agent:mcpAddServer', server),
    mcpRemoveServer:(name)          => ipcRenderer.invoke('agent:mcpRemoveServer', name),
    mcpConnect:     (name)          => ipcRenderer.invoke('agent:mcpConnect', name),
    mcpDisconnect:  (name)          => ipcRenderer.invoke('agent:mcpDisconnect', name),
    mcpListTools:   ()              => ipcRenderer.invoke('agent:mcpListTools'),
    mcpCallTool:    (name, args)    => ipcRenderer.invoke('agent:mcpCallTool', name, args),
